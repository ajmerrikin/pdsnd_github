...
def user_stats(df,city):
    ...
    # Display earliest, most recent, and most common year of birth
        ...
        print('Earliest year of birth is {}. Most recent year of birth is: {}. Most common year of birth is {}'.format(earliest_year_of_birth,recent_year_of_birth,most_common_year_of_birth))
